  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "glow-primary-sm": "0 0.25rem 0.75rem rgba(21, 93, 252, 0.28)",
        "glow-primary-sm-hover": "0 0.325rem 1rem rgba(21, 93, 252, 0.36)",
        "glow-secondary": "0 0.5rem 1.5rem rgba(218, 116, 136, 0.35)",
        "glow-secondary-hover": "0 0.625rem 2rem rgba(218, 116, 136, 0.45)",
        "glow-secondary-sm": "0 0.25rem 0.75rem rgba(218, 116, 136, 0.28)",
        "glow-secondary-sm-hover": "0 0.325rem 1rem rgba(218, 116, 136, 0.36)",
        "glow-success": "0 0.5rem 1.5rem rgba(16, 185, 129, 0.35)",
        "glow-success-hover": "0 0.625rem 2rem rgba(16, 185, 129, 0.45)",
        "glow-success-sm": "0 0.25rem 0.75rem rgba(16, 185, 129, 0.28)",
        "glow-success-sm-hover": "0 0.325rem 1rem rgba(16, 185, 129, 0.36)",
        "glow-danger": "0 0.5rem 1.5rem rgba(239, 68, 68, 0.35)",
        "glow-danger-hover": "0 0.625rem 2rem rgba(239, 68, 68, 0.45)",
        "glow-danger-sm": "0 0.25rem 0.75rem rgba(239, 68, 68, 0.28)",
        "glow-danger-sm-hover": "0 0.325rem 1rem rgba(239, 68, 68, 0.36)",
